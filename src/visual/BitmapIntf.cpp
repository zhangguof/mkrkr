...
//----------------------------------------------------------------------
void tTJSNI_Bitmap::SetSize(tjs_int width, tjs_int height, bool keepimage) {
	if(!Bitmap) TVPThrowExceptionMessage(TVPNotDrawableLayerType);
...
//----------------------------------------------------------------------
void tTJSNI_Bitmap::SetSizeAndImageBuffer( tjs_int width, tjs_int height, void* bits ) {
	if(!Bitmap) TVPThrowExceptionMessage(TVPNotDrawableLayerType);
...
//----------------------------------------------------------------------
void tTJSNI_Bitmap::SetWidth(tjs_int width) {
	if( Loading ) TVPThrowExceptionMessage(TVPCurrentlyAsyncLoadBitmap);
	if(!Bitmap) TVPThrowExceptionMessage(TVPNotDrawableLayerType);
...
//----------------------------------------------------------------------
tjs_int tTJSNI_Bitmap::GetWidth() const {
	if( Loading ) TVPThrowExceptionMessage(TVPCurrentlyAsyncLoadBitmap);
	if(!Bitmap) TVPThrowExceptionMessage(TVPNotDrawableLayerType);
	return Bitmap->GetWidth();
}
//----------------------------------------------------------------------
void tTJSNI_Bitmap::SetHeight(tjs_int height) {
	if( Loading ) TVPThrowExceptionMessage(TVPCurrentlyAsyncLoadBitmap);
	if(!Bitmap) TVPThrowExceptionMessage(TVPNotDrawableLayerType);
...
//----------------------------------------------------------------------
tjs_int tTJSNI_Bitmap::GetHeight() const {
	if( Loading ) TVPThrowExceptionMessage(TVPCurrentlyAsyncLoadBitmap);
	if(!Bitmap) TVPThrowExceptionMessage(TVPNotDrawableLayerType);
...
TJS_BEGIN_NATIVE_PROP_DECL(buffer)
{
	TJS_BEGIN_NATIVE_PROP_GETTER
	{
		TJS_GET_NATIVE_INSTANCE(/*var. name*/_this, /*var. type*/tTJSNI_Bitmap);
		if( _this->IsLoading() ) TVPThrowExceptionMessage(TVPCurrentlyAsyncLoadBitmap);
		*result = reinterpret_cast<const void*>(_this->GetPixelBuffer());
		return TJS_S_OK;
	}
	TJS_END_NATIVE_PROP_GETTER
...
TJS_BEGIN_NATIVE_PROP_DECL(bufferForWrite)
{
	TJS_BEGIN_NATIVE_PROP_GETTER
	{
		TJS_GET_NATIVE_INSTANCE(/*var. name*/_this, /*var. type*/tTJSNI_Bitmap);
		if( _this->IsLoading() ) TVPThrowExceptionMessage(TVPCurrentlyAsyncLoadBitmap);
		*result = reinterpret_cast<const void*>(_this->GetPixelBufferForWrite());
		return TJS_S_OK;
	}
	TJS_END_NATIVE_PROP_GETTER

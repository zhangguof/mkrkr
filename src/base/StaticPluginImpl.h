...
extern "C"
{
	...
	// V2 plug-in
	typedef HRESULT ( * tTVPV2LinkProc)(iTVPFunctionExporter *);
	typedef HRESULT ( * tTVPV2UnlinkProc)();

	// TSS
	// typedef HRESULT ( * tTVPGetModuleInstanceProc)(ITSSModule **out,
	// 	ITSSStorageProvider *provider, IStream * config, HWND mainwin);
	// typedef ULONG ( * tTVPGetModuleThreadModelProc)(void);
	// typedef HRESULT ( * tTVPShowConfigWindowProc)(HWND parentwin,
	// 	IStream * storage );
	// typedef ULONG ( * tTVPCanUnloadNowProc)(void);

// #ifdef TVP_SUPPORT_OLD_WAVEUNPACKER
// 	// WaveUnpacker
// 	typedef HRESULT ( * tTVPCreateWaveUnpackerProc)(IStream *storage,long size,

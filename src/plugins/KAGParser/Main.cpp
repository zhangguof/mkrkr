...
extern "C" DLL_EXPORT HRESULT STDCALL KAGParser_V2Link(iTVPFunctionExporter *exporter)
{
	// スタブの初期化(必ず記述する)
	...
	printf("init KAGParser succss!!!\n");

	return TJS_S_OK;
}
//---------------------------------------------------------------------------
extern "C" DLL_EXPORT HRESULT STDCALL KAGParser_V2Unlink()
{
